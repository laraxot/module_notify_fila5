---
title: "Architettura WhatsApp Provider per App"
type: concept
tags: [whatsapp, provider, architecture]
created: 2026-07-14
updated: 2026-07-14
qmd: "whatsapp-provider-architecture-2 architettura whatsapp provider per this-project"
...
# Architettura WhatsApp Provider per App

Questo documento definisce l'architettura e gli standard per l'implementazione dei provider WhatsApp nel modulo Notify di App, mantenendo coerenza con le architetture esistenti per SMS ed email.
