...
**Affected Modules**: Tenant (25+), App (10+), Xot (2), Rating (1)
...
**Affected Modules**: App (13), Tenant (8)
...
**Affected Modules**: App (6), Cms (4), Blog (2)
...
**Affected Modules**: App (2), Xot (1), Cms (2)
