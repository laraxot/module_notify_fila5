...
- [📊 **Session Summary**](./session-summary.md) - Riepilogo completo e piano per domani
- [📝 **Final Report**](./final-report-session.md) - Report dettagliato con statistiche e achievement
