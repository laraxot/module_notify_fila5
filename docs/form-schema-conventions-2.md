...
created: 2026-07-14
updated: 2026-07-14
qmd: "form-schema-conventions-2 convenzioni per i form schema"
...
```bash
find /var/www/_bases/base_ptvx_fila5/laravel/Modules -type f -name "*.php" -exec grep -l "get.*FormSchema" {} \; | xargs grep -l "return \["
```
