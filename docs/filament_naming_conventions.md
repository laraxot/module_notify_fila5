...
Questo documento definisce le convenzioni di naming standardizzate per i componenti Filament nel sistema Laraxot, con particolare attenzione alle pagine e alle risorse. (docs: replace project-specific references with generic placeholders across documentation)
