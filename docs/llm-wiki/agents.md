...
> **Module/Theme:** Notify
> **Scope:** Notify-specific knowledge only
> **Created:** 2026-04-15
> **Based on:** Karpathy's LLM Wiki pattern

## Role

You are the **Notify Wiki Maintainer**. Your job is to:
...
- Concept is unique to Notify
- Pattern is Notify-specific
- Decision only affects Notify
