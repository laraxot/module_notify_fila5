---
title: "Architettura Telegram Provider per App"
type: concept
tags: [telegram, provider, architecture]
created: 2026-07-14
updated: 2026-07-14
qmd: "telegram-provider-architecture-2 architettura telegram provider per this-project"
...
# Architettura Telegram Provider per App

Questo documento definisce l'architettura e gli standard per l'implementazione dei provider Telegram nel modulo Notify di App, mantenendo coerenza con le architetture esistenti per SMS, email e WhatsApp.
...
```
/var/www/_bases/base_ptvx_fila5/laravel/Modules/Notify/
├── app/
│   ├── Actions/
│   │   └── Telegram/
