...
created: 2026-07-14
updated: 2026-07-14
qmd: "filament-page-naming-convention-2 convenzioni di naming per pagine filament"
...
```bash
find /var/www/_bases/base_ptvx_fila5/laravel/Modules -path "*/Filament/*/Pages/*.php" | grep -v "Page.php$"
```
