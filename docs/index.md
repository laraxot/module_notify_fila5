...
> template non adattato). Contenuto consolidato: **usare [`README.md`](./README.md) come indice canonico**.
> `index-1.md` e `index-conflict.md` restano solo come riferimento storico — non aggiornarli, non linkarli da
> nuova documentazione.

Per l'indice reale e aggiornato del modulo Notify vedi **[README.md](./README.md)**.

Doc verificati utili:
