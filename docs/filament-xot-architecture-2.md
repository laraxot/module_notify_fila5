---
title: "Architettura Filament : Pattern XotBase"
type: concept
tags: [filament, xot, architecture]
created: 2026-07-14
updated: 2026-07-14
qmd: "filament-xot-architecture-2 architettura filament : pattern xotbase"
...
App utilizza un pattern architetturale fondamentale per l'integrazione con Filament: **non estendere mai direttamente** le classi Filament, ma utilizzare sempre le classi wrapper con prefisso `XotBase` fornite dal modulo `Xot`.
...
```bash
find /var/www/_bases/base_ptvx_fila5/laravel/Modules -type f -name "*.php" -exec grep -l "extends.*\\\\Filament\\\\Pages\\\\Page" {} \;
```
