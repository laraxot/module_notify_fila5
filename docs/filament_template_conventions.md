...
grep -L "name=\"footer\"" /var/www/html/ptvx/laravel/Modules/*/resources/views/filament/pages/*.blade.php (docs: replace project-specific references with generic placeholders across documentation)
```
