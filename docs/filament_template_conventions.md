...
```bash
grep -L "name=\"description\"" [project-root]/laravel/Modules/*/resources/views/filament/pages/*.blade.php
grep -L "name=\"footer\"" [project-root]/laravel/Modules/*/resources/views/filament/pages/*.blade.php
```
