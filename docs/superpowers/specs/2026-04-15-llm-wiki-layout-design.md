...
> Questo file è stato rinominato in [llm-wiki-layout-design-1.md](llm-wiki-layout-design-1.md). Non aggiungere date nel filename; usare `created/updated` nel front matter.
