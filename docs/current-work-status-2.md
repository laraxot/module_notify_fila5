...
created: 2026-07-14
updated: 2026-07-14
qmd: "current-work-status-2 stato attuale del lavoro - 12 maggio 2025"
...
- **Errore**: File di traduzione come `send_whats_app.php` utilizzano convenzioni che differiscono dalle convenzioni generali di App
...
- È importante rispettare le convenzioni specifiche del modulo Notify, anche se differiscono dalle convenzioni generali di App
