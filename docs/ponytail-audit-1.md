---
title: "Ponytail-audit 2026-07-02: Notify module findings"
type: concept
tags: [ponytail, audit, 2026, 02.deprecated]
created: 2026-07-14
updated: 2026-07-14
qmd: "ponytail-audit-2026-07-02.deprecated ponytail-audit 2026-07-02: notify module findings"
...
Source: repo-wide ponytail-audit, published as GitHub issues [#103](https://github.com/laraxot/base_ptvx_fila5/issues/103) and [#112](https://github.com/laraxot/base_ptvx_fila5/issues/112), summarized in discussion [#114](https://github.com/laraxot/base_ptvx_fila5/discussions/114).
...
Discussion [#82](https://github.com/laraxot/base_ptvx_fila5/discussions/82) / [#83](https://github.com/laraxot/base_ptvx_fila5/discussions/83) established a repository-wide architecture rule: **business logic must live in `QueueableAction` classes (`spatie/laravel-queueable-action`), never in Service classes.** `Modules/Xot/app/Services/` and `Modules/Job/app/Services/` are the only allowed exception (framework wrappers, not business logic).
