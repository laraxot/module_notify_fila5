...
> Questo file è stato rinominato in [final-implementation-report-1.md](final-implementation-report-1.md). Non aggiungere date nel filename; usare `created/updated` nel front matter.
