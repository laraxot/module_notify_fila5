...
> Questo file è stato rinominato in [completion-summary-1.md](completion-summary-1.md). Non aggiungere date nel filename; usare `created/updated` nel front matter.
