...
> Questo file è stato rinominato in [super-mucca-completion-report-1.md](super-mucca-completion-report-1.md). Non aggiungere date nel filename; usare `created/updated` nel front matter.
