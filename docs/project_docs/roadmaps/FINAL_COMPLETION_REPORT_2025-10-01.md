...
> Questo file è stato rinominato in [final-completion-report-1.md](final-completion-report-1.md). Non aggiungere date nel filename; usare `created/updated` nel front matter.
