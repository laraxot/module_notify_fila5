...
created: 2026-07-14
updated: 2026-07-14
qmd: "immediate-actions-2025-01-27 deprecated"
status: deprecated
related:
...
> Questo file è stato rinominato in [immediate-actions-1.md](immediate-actions-1.md). Non aggiungere date nel filename; usare `created/updated` nel front matter.
