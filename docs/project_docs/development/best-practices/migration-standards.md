...
Questo documento definisce gli standard e le best practices da seguire per tutte le migrazioni nei moduli del sistema Laraxot. Questi standard sono fondamentali per garantire la coerenza e la correttezza delle migrazioni in tutto il progetto.
 ...
 * 
 * @see docs/development/best-practices/migration-standards.md
 */
...
Il sistema utilizza diverse connessioni al database per diversi tipi di dati:
...
- [Best Practices Modulo User](../../modules/user/migration-best-practices.md)
- [Best Practices Modulo Tenant](../../modules/tenant/migration-best-practices.md)
- [Best Practices Modulo Patient](../../modules/patient/migration-best-practices.md)
...
- [Troubleshooting Migrations](../../troubleshooting/errors/migration-errors.md)
