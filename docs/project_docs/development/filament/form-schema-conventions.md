...
Nel sistema Laraxot, il metodo `getFormSchema()` nelle risorse Filament deve **SEMPRE** restituire un array associativo con chiavi stringhe, mai un array numerico.
...
- [Troubleshooting Form](../../troubleshooting/errors/form-errors.md)
