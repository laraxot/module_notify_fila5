...
module: Notify
updated: 2026-09-01
qmd: "tabella filament resource table class getTableFilters XotBaseResourceTable HasXotTable list page notify"
---
...
```php
namespace Modules\Notify\Filament\Resources\FooResource\Tables;
