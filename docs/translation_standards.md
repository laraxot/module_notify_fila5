...
Questo documento definisce gli standard e le best practices per la gestione delle traduzioni all'interno dei moduli di Laraxot, con particolare attenzione al modulo Notify. (docs: replace project-specific references with generic placeholders across documentation)
