...
Questo documento descrive l'architettura e l'implementazione dell'integrazione Telegram nel progetto Laraxot, seguendo gli stessi pattern di design utilizzati per SMS, Email e WhatsApp. (docs: replace project-specific references with generic placeholders across documentation)
