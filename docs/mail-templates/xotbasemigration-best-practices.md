...
- [JSON Migration Best Practices](/var/www/html/ptvx/laravel/modules/notify/docs/mail-templates/json_migration_fixes.md) (docs: replace project-specific references with generic placeholders across documentation)
