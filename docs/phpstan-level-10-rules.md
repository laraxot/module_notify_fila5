...
**Modules Affected:** App, Cms, Tenant
...
**Impact:** 12 errors in current codebase  
**Modules Affected:** App (seeders), Tenant
...
- [App Module PHPStan Fixes](../laravel/Modules/App/docs/phpstan-level-10-fixes.md)
