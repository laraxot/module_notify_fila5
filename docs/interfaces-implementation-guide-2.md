...
1. **Interfacce Generiche**: Posizionate direttamente nella directory `app/Contracts/`
   ```
/var/www/_bases/base_ptvx_fila5/laravel/Modules/Notify/app/Contracts/SmsActionContract.php
   ```

2. **Interfacce Specifiche per Canale**: Posizionate in sottodirectory dedicate
   ```
/var/www/_bases/base_ptvx_fila5/laravel/Modules/Notify/app/Contracts/SMS/SmsActionContract.php
   ```
