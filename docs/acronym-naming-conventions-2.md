...
created: 2026-07-14
updated: 2026-07-14
qmd: "acronym-naming-conventions-2 convenzioni di naming per acronimi"
...
```bash
find /var/www/_bases/base_ptvx_fila5/laravel/Modules -type f -name "*[A-Z][A-Z]*.php" | grep -v "Test\\.php$" | grep -v "HTML\\.php$"
```
