...
/var/www/html/ptvx/laravel/Modules/Notify/app/Datas/SmsData.php (docs: replace project-specific references with generic placeholders across documentation)
```
...
```bash
find /var/www/html/ptvx/laravel/Modules/Notify/app -type d -name "Data*" (docs: replace project-specific references with generic placeholders across documentation)
```

Questo restituirà:
```
/var/www/html/ptvx/laravel/Modules/Notify/app/Datas
/var/www/html/ptvx/laravel/Modules/Notify/app/Datas/SMS (docs: replace project-specific references with generic placeholders across documentation)
```
