...
```bash
find /var/www/html/ptvx/laravel/Modules -path "*/Filament/*/Pages/*.php" | grep -v "Page.php$" (docs: replace project-specific references with generic placeholders across documentation)
```
