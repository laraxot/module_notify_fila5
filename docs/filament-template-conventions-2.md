...
created: 2026-07-14
updated: 2026-07-14
qmd: "filament-template-conventions-2 convenzioni per template blade di filament"
...
```bash
grep -L "name=\"description\"" /var/www/_bases/base_ptvx_fila5/laravel/Modules/*/resources/views/filament/pages/*.blade.php
grep -L "name=\"footer\"" /var/www/_bases/base_ptvx_fila5/laravel/Modules/*/resources/views/filament/pages/*.blade.php
```
