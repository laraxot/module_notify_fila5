...
in /var/www/_bases/base_ptvx_fila5/laravel/app/Application.php:9
```
...
1. `/var/www/_bases/base_ptvx_fila5/laravel/composer.json` - **NEEDS FIX**
2. `/var/www/_bases/base_ptvx_fila5/laravel/app/Application.php` - depends on Illuminate
3. `/var/www/_bases/base_ptvx_fila5/laravel/bootstrap/app.php` - bootstrap process
