...
```
/var/www/_bases/base_ptvx_fila5/laravel/Modules/Notify/app/Actions/SMS
/var/www/_bases/base_ptvx_fila5/laravel/Modules/Notify/app/Http/Controllers
/var/www/_bases/base_ptvx_fila5/laravel/Modules/Notify/app/Providers
/var/www/_bases/base_ptvx_fila5/laravel/Modules/Notify/app/Models
/var/www/_bases/base_ptvx_fila5/laravel/Modules/Notify/app/Filament
```
...
```
/var/www/_bases/base_ptvx_fila5/laravel/Modules/Notify/app/Actions/SMS/SendNetfunSmsAction.php
```
...
**Path fisico corretto:**
```
/var/www/_bases/base_ptvx_fila5/laravel/Modules/Notify/app/Http/Controllers/NotificationController.php
```
...
**Path fisico corretto:**
```
/var/www/_bases/base_ptvx_fila5/laravel/Modules/Notify/app/Providers/NotifyServiceProvider.php
```
...
**Path fisico corretto:**
```
/var/www/_bases/base_ptvx_fila5/laravel/Modules/Notify/app/Datas/NetfunSMSMessage.php
```
...
**Path fisico corretto:**
```
/var/www/_bases/base_ptvx_fila5/laravel/Modules/Notify/app/Console/Commands/AnalyzeTranslationFiles.php
```
