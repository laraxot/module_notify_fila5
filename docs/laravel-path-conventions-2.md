---
title: "Convenzioni dei Path in Laravel e App"
type: concept
tags: [laravel, path, conventions]
created: 2026-07-14
updated: 2026-07-14
qmd: "laravel-path-conventions-2 convenzioni dei path in laravel e this-project"
...
# Convenzioni dei Path in Laravel e App

## Regole Fondamentali per i Path di Cartelle

In Laravel e App, i nomi delle cartelle principali (come definite nella struttura standard di Laravel) **DEVONO** rispettare il caso specifico definito dalle convenzioni di Laravel.
...
```
/var/www/_bases/base_ptvx_fila5/laravel/Modules/Notify/resources/views/
```
...
// /var/www/_bases/base_ptvx_fila5/laravel/Modules/Notify/resources/views/filament/pages/send-sms.blade.php
```
