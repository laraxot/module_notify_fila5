...
=======
   > NOTA: È fondamentale utilizzare esattamente il comando `laravel new laravel`. Non utilizzare varianti come `laravel new <nome progetto>` o `laravel new laravel --version=X.Y`.
>>>>>>> dev
