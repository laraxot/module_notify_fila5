                                    ...
                                    <div class="card-wrapper">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="card-meta">
                                                    <span
                                                        class="badge badge-{{ $ticket->priority }}">{{ $ticket->priority_label }}</span>
                                                    <span
                                                        class="badge badge-{{ $ticket->status }}">{{ $ticket->status_label }}</span>
                                                </div>
                                                <a href="{{ route('fixcity.tickets.show', $ticket) }}"
                                    ...
                                    <div class="card-wrapper">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="card-meta">
                                                    <small
                                                        class="text-muted">{{ $news->created_at->format('d/m/Y') }}</small>
                                                </div>
                                                <a href="{{ route('comune.novita.show', $news) }}"
                                                    class="btn btn-outline-primary btn-sm">Leggi</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
