...
```
docs/body-structure-comparison/         ← This directory (theme-specific output)
...
The following files were moved to correct locations:
- `local_segnalazioni.html` → `docs/prompts/segnalazione_disservizio/local_segnalazioni.html`
- `segnalazioni-elenco-html-parity-analysis.md` → `docs/prompts/segnalazione_disservizio/segnalazioni-elenco-html-parity-analysis.md`
