        ...
        <div class="container">
            ...
            <div class="row g-4">
                @foreach ($items as $item)
                    <div class="col-md-6 col-lg-4"> <!-- ee -->
                            ...
                            <div class="card card-teaser no-after rounded shadow-sm border border-light h-100">
                                <div class="card-body pb-5">
                                    ...
                                    @if (!empty($item['external_site']))
                                        ...
                                        <a href="{{ $item['external_site']['url'] ?? '#' }}"
                                            class="card card-teaser card-bg-blue no-after rounded mt-0 p-3">
                                            <div class="avatar size-lg me-3">
                                                <img src="{{ $item['external_site']['image'] ?? 'https://picsum.photos/200/200' }}"
                                                    alt="Immagine">
                                            </div>
                                            <div class="card-body">
                                                <h4 class="card-title text-white mb-1">
                                                    {{ $item['external_site']['title'] ?? '' }}</h4>
                                                <p class="card-text text-sans-serif text-white">
                                                    {{ $item['external_site']['description'] ?? '' }}</p>
                                            </div>
                                        </a>
                                    @endif
                                ...
                                <a class="read-more text-success pt-0" href="{{ $item['url'] ?? '#' }}">
                                    ...
                                    <svg class="icon ms-0">
                                        <use
                                            href="{{ asset('themes/Sixteen/design-comuni/assets/bootstrap-italia/dist/svg/sprites.svg#it-arrow-right') }}">
                                        </use>
                                    </svg>
                                </a>
                            </div>
                ...
                <div class="row pt-30">
                    <div class="col-lg-10 col-xl-6 offset-lg-1 offset-xl-2">
                        <div class="row d-lg-inline-flex">
                            <div class="col-lg-3">
                                <h3 class="text-uppercase mb-3 title-xsmall-bold text text-secondary">Altri argomenti
                                </h3>
                            </div>
                            <div class="col-lg-9">
                ...
                <div class="pt-4 pt-lg-30">
                    <div class="row g-4">
                        @foreach ($thematic_sites as $site)
                            ...
                            @endphp
                            <div class="col-md-6 col-lg-4"> <!-- ff -->
                                <div
                                    class="card-wrapper card-teaser-wrapper card-teaser-wrapper-equal card-teaser-block-3 pb-0">
                                    <a href="{{ $site['url'] ?? '#' }}"
                                        class="card card-teaser {{ $colorClass }} rounded mt-0 p-3 h-100 text-decoration-none">
                                        <div class="d-flex align-items-start">
                                            <div class="avatar size-lg me-3 flex-shrink-0">
                                                <img src="{{ $site['image'] ?? 'https://picsum.photos/200/200' }}"
                                                    alt="Immagine">
                                            </div>
                                            <div class="card-body p-0">
                                                <h3
                                                    class="card-title {{ $site['color'] === 'warning' ? '' : 'text-white' }} sito-tematico">
                                                    {{ $site['title'] }}
                                                </h3>
                                                <p
                                                    class="card-text text-sans-serif {{ $site['color'] === 'warning' ? '' : 'text-white' }} mb-0">
                                                    {{ $site['description'] }}
                                                </p>
                                            </div>
                                        </div>
