...
@php
    ...
    if ($breadcrumbItems === []) {
        $breadcrumbItems = [
            ['label' => __($ns . '.breadcrumb.home.label'), 'url' => '/' . app()->getLocale() . '/tests/homepage'],
...
<div class="container" id="main-container">
    ...
    @if (!empty($filters['items']))
        <div class="it-example-modal">
            <div class="modal fade" id="modal-disservizio" tabindex="-1" role="dialog" aria-labelledby="modal2Title" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h2 class="modal-title h4" id="modal2Title">{{ $filters['title'] }}</h2>
                                    ...
                                    <ul>
                                        @foreach ($filters['items'] as $filter)
                                            <li>
                                                <div class="form-check">
                                                    <div class="checkbox-body border-light py-1">
                                                        <input type="checkbox" id="mobile-{{ $filter['id'] }}" name="category" value="{{ $filter['value'] ?? '' }}">
                                                        <label for="mobile-{{ $filter['id'] }}" class="subtitle-small_semi-bold mb-0 category-list__list">
                                                            {{ $filter['label'] }} ({{ $filter['count'] ?? 0 }})
                                                        </label>
                                                    </div>
                                                </div>
