...
@php
    ...
    // NOTE: base_path() is already /var/www/_bases/base_fixcity_fila5/laravel
    // So we use 'config/...' NOT 'laravel/config/...'
        ...
        @foreach($blocks as $block)
            @if(isset($block['type']))
                @php
                    ...
                    // Use the view path from JSON data, fallback to type-based path with namespace
