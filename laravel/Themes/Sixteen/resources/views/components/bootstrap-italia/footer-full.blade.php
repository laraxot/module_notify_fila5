        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 footer-items-wrapper logo-wrapper">
                    <img class="ue-logo" src="{{ asset('themes/sixteen/bootstrap-italia/dist/images/logo-eu-inverted.svg') }}" alt="logo Unione Europea">
                ...
                <div class="col-md-3 mt-md-4 footer-items-wrapper">
                    ...
                    <ul class="list-inline text-start social">
                        <li class="list-inline-item">
                            <a class="p-1 text-white" href="#" target="_blank">
                                <svg class="icon icon-sm icon-white align-top">
                                    <use href="{{ asset('themes/sixteen/bootstrap-italia/dist/svg/sprites.svg#it-twitter') }}"></use>
                                </svg>
                        ...
                        <li class="list-inline-item">
                            <a class="p-1 text-white" href="#" target="_blank">
                                <svg class="icon icon-sm icon-white align-top">
                                    <use href="{{ asset('themes/sixteen/bootstrap-italia/dist/svg/sprites.svg#it-facebook') }}"></use>
                                </svg>
                        ...
                        <li class="list-inline-item">
                            <a class="p-1 text-white" href="#" target="_blank">
                                <svg class="icon icon-sm icon-white align-top">
                                    <use href="{{ asset('themes/sixteen/bootstrap-italia/dist/svg/sprites.svg#it-youtube') }}"></use>
                                </svg>
                        ...
                        <li class="list-inline-item">
                            <a class="p-1 text-white" href="#" target="_blank">
                                <svg class="icon icon-sm icon-white align-top">
                                    <use href="{{ asset('themes/sixteen/bootstrap-italia/dist/svg/sprites.svg#it-telegram') }}"></use>
                                </svg>
                        ...
                        <li class="list-inline-item">
                            <a class="p-1 text-white" href="#" target="_blank">
                                <svg class="icon icon-sm icon-white align-top">
                                    <use href="{{ asset('themes/sixteen/bootstrap-italia/dist/svg/sprites.svg#it-whatsapp') }}"></use>
                                </svg>
                        ...
                        <li class="list-inline-item">
                            <a class="p-1 text-white" href="#" target="_blank">
                                <svg class="icon icon-sm icon-white align-top">
                                    <use href="{{ asset('themes/sixteen/bootstrap-italia/dist/svg/sprites.svg#it-rss') }}"></use>
                                </svg>
