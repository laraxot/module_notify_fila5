...
@props([
    ...
    'logoUrl' => '/themes/sixteen/bootstrap-italia/dist/svg/sprites.svg#it-pa',
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <ul class="footer-list">
                                ...
                                <li>
                                    <a href="{{ $link['url'] }}" @if(isset($link['data-element'])) data-element="{{ $link['data-element'] }}" @endif>
                                        {{ $link['label'] }}
                                    </a>
                                </li>
                                @endforeach
