...
return [
    'connections' => [
        ...
        '<nome progetto>' => [
            ...
            'port' => env('DB_PORT', '3306'),
            // 'unix_socket' => '/Applications/MAMP/tmp/mysql/mysql.sock',
            'database' => env('DB_DATABASE_<nome progetto>', 'forge26'),
            'username' => env('DB_USERNAME_<nome progetto>', 'forge27'),
            'password' => env('DB_PASSWORD_<nome progetto>', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'strict' => false,
        ...
        'orbit' => [
            ...
            // "database" => '/var/www/html/_bases/base_siram_idoteca_fila5/laravel/config/local/idoteca/orbit.sqlite',
