...
- **Format**: `tenant-vX.Y.Z` (e.g., `tenant-v1.2.3`)
...
2. **Build Artifact**: Creates a tarball of the module (`laravel/Modules/Tenant`).
...
4. **Bump Version & Push Tag**:
   ...
   - Pushes the new tag `tenant-v...` to the repository.
   - Creates a GitHub Release with auto-generated changelog.

## Configuration

- **Workflow**: `laravel/Modules/Tenant/.github/workflows/semantic-versioning.yml`
- **Release Config**: `laravel/Modules/Tenant/.releaserc.json`
