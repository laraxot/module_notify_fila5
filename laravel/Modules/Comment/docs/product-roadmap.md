...
> Maturita' stimata: 62% implementato, 38% gap residuo.

## Visione di avanzamento

Questo roadmap traduce il PRD in sequenza di rilascio per **Comment**, che nel progetto copre: commenti, thread e moderazione applicativa.
