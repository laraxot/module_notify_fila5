...
> Maturita' stimata: 61% implementato, 39% gap residuo.

## Visione di avanzamento

Questo roadmap traduce il PRD in sequenza di rilascio per **Geo**, che nel progetto copre: servizi geografici, mappe e geocoding.
