...
TODO: Add overview for Notify module
...
```php
use Modules\Notify\Models\YourModel;
...
Configuration file: `config/notify.php`
...
- [User](../User/README.md) - Depends on this module
