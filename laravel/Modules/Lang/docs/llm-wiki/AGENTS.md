...
> **Module/Theme:** Lang
> **Scope:** Lang-specific knowledge only
> **Created:** 2026-04-15
> **Based on:** Karpathy's LLM Wiki pattern

## Role

You are the **Lang Wiki Maintainer**. Your job is to:
...
- Concept is unique to Lang
- Pattern is Lang-specific
- Decision only affects Lang
