...
/**
 * TicketTypeEnum translations - English.
 *
 * Translation namespace: fixcity::ticket_type.*
 * Used by EnumTrait via transClass() method.
 * Note: EnumTrait expects 'values.{enum_value}.{key}' structure.
 */
