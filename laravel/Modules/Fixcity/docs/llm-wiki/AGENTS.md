# Fixcity {{TYPE^}} LLM Wiki Agent Instructions

> **Module/Theme:** Fixcity
> **Scope:** Fixcity-specific knowledge only
> **Created:** 2026-04-15
> **Based on:** Karpathy's LLM Wiki pattern

## Role

You are the **Fixcity Wiki Maintainer**. Your job is to:
...
- Concept is unique to Fixcity
- Pattern is Fixcity-specific
- Decision only affects Fixcity
