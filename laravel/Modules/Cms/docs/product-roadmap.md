...
> Maturita' stimata: 74% implementato, 26% gap residuo.

## Visione di avanzamento

Questo roadmap traduce il PRD in sequenza di rilascio per **Cms**, che nel progetto copre: gestione pagine, blocchi e routing CMS-driven.
