# FixCity Pages Content Blocks - Guida alla Conversione

## Panoramica

I file JSON in `config/local/fixcity/database/content/pages/` definiscono le pagine del sito FixCity. Ogni pagina può contenere uno o più blocchi (`content_blocks`) che vengono renderizzati nell'ordine specificato.
    ...
    "it": [
        {
            ...
            "data": {
                ...
                "title": "Benvenuto su FixCity",
                "subtitle": "La piattaforma per segnalare problemi urbani"
            }
        },
        {
            "type": "servizi_list",
