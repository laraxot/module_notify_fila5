...
> **Module/Theme:** Blog
> **Scope:** Blog-specific knowledge only
> **Created:** 2026-04-15
> **Based on:** Karpathy's LLM Wiki pattern

## Role

You are the **Blog Wiki Maintainer**. Your job is to:
...
- Concept is unique to Blog
- Pattern is Blog-specific
- Decision only affects Blog
