...
> Maturita' stimata: 72% implementato, 28% gap residuo.

## Visione di avanzamento

Questo roadmap traduce il PRD in sequenza di rilascio per **Blog**, che nel progetto copre: backbone editoriale con articoli, categorie, banner e profili.
