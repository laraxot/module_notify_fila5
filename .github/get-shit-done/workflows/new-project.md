...
```bash
node .github/get-shit-done/bin/gsd-tools.cjs config-set workflow.auto_advance true
```
...
```
Task(prompt="First, read .github/agents/gsd-project-researcher.md for your role and instructions.
