...
test('netfun notifications channel sends and increases counter', function (): void {
...
test('telegram notifications channel logs when recipient and method are valid', function (): void {
...
test('telegram notifications channel throws when notification has no toTelegram method', function (): void {
    $channel = new TelegramChannel;
