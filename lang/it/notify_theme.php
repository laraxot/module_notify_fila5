...
return [
    ...
    'fields' => [
        ...
        'subject' => ['label' => 'subject', 'placeholder' => 'subject', 'helper_text' => '', 'description' => 'subject'],
        'from' => ['label' => 'from', 'placeholder' => 'from', 'helper_text' => '', 'description' => 'from'],
        'from_email' => ['label' => 'from_email', 'placeholder' => 'from_email', 'helper_text' => '', 'description' => 'from_email'],
        'logo_src' => ['label' => 'logo_src', 'placeholder' => 'logo_src', 'helper_text' => '', 'description' => 'logo_src'],
        'logo_width' => ['label' => 'logo_width', 'placeholder' => 'logo_width', 'helper_text' => '', 'description' => 'logo_width'],
        'logo_height' => ['label' => 'logo_height', 'placeholder' => 'logo_height', 'helper_text' => '', 'description' => 'logo_height'],
        'theme' => ['label' => 'theme', 'placeholder' => 'theme', 'helper_text' => '', 'description' => 'theme'],
