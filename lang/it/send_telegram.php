...
return [
    ...
    'fields' => [
        ...
        'disable_notification' => ['label' => 'disable_notification', 'placeholder' => 'disable_notification', 'helper_text' => '', 'description' => 'disable_notification'],
        'reply_to_message_id' => ['label' => 'reply_to_message_id', 'placeholder' => 'reply_to_message_id', 'helper_text' => '', 'description' => 'reply_to_message_id'],
        'media_url' => ['label' => 'media_url', 'placeholder' => 'media_url', 'helper_text' => '', 'description' => 'media_url'],
        'media_type' => ['label' => 'media_type', 'placeholder' => 'media_type', 'helper_text' => '', 'description' => 'media_type'],
        'caption' => ['label' => 'caption', 'placeholder' => 'caption', 'helper_text' => '', 'description' => 'caption'],
